...
public class ElectronicDeviceImpl implements IElectronicDeviceDAO{
	Connection con=null;
	String addDeviceQuery="insert into electronicdb.electronicdevice values(?,?,?,?,?,?,?)";
	String displayAllDeviceQuery="select * from electronicdb.electronicdevice";
	@Override
	public boolean addDevice(ElectronicDevice device) throws Exception {
		...
		if(con!=null)
		{
			...
			PreparedStatement ps = con.prepareStatement(addDeviceQuery);
	...
	public List<ElectronicDevice> getAllDevices() throws Exception {
		...
		if(con!=null)
		{
			...
			PreparedStatement ps=con.prepareStatement(displayAllDeviceQuery);
